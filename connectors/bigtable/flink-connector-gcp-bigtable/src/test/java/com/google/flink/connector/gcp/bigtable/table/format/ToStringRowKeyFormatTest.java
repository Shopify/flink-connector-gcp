...
public class ToStringRowKeyFormatTest {
    ...
    public void testFormatBigintField() {
        ...
        assertEquals("0000000000000012345", format.format(row));
    }
    ...
    public void testFormatIntField() {
        ...
        assertEquals("0000000000000000999", format.format(row));
    }
    ...
    public void testFormatSmallintField() {
        ...
        assertEquals("0000000000000000042", format.format(row));
    }
    ...
    public void testFormatTinyintField() {
        ...
        assertEquals("0000000000000000007", format.format(row));
    }
}
